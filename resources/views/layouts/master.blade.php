...
<head>
    ...
    <link href="{{ asset('theme/vendor/fontawesome-6.7.2/css/all.min.css') }}" rel="stylesheet" media="all">
    <link href="{{ asset('theme/vendor/mdi-font/css/material-design-iconic-font.min.css') }}" rel="stylesheet" media="all">
    <!-- Bootstrap CSS-->
    <link href="{{ asset('theme/vendor/bootstrap-5.3.7.min.css') }}" rel="stylesheet" media="all">
    <!-- Vendor CSS-->
    <link href="{{ asset('theme/css/aos.css') }}" rel="stylesheet" media="all">
    <link href="{{ asset('theme/vendor/css-hamburgers/hamburgers.min.css') }}" rel="stylesheet" media="all">
    <link href="{{ asset('theme/css/swiper-bundle.min.css') }}" rel="stylesheet" media="all">
                                                ...
                                                <div class="au-message__item-inner">
                                                    <div class="au-message__item-text">
                                                        <div class="avatar-wrap">
                                                            <div class="avatar">
                                                                <img src="{{ asset('theme/images/icon/avatar-02.jpg')}}" alt="John Smith">
                                                            </div>
                                                        </div>
                                                        <div class="text">
                                                ...
                                                <div class="au-message__item-inner">
                                                    <div class="au-message__item-text">
                                                        <div class="avatar-wrap online">
                                                            <div class="avatar">
                                                                <img src="{{ asset('theme/images/icon/avatar-03.jpg')}}" alt="Nicholas Martinez">
                                                            </div>
                                                        </div>
                                                        <div class="text">
                                            ...
                                            <div class="au-message__item">
                                                <div class="au-message__item-inner">
                                                    <div class="au-message__item-text">
                                                        <div class="avatar-wrap online">
                                                            <div class="avatar">
                                                                <img src="{{ asset('theme/images/icon/avatar-04.jpg')}}" alt="Michelle Sims">
                                                            </div>
                                                        </div>
                                                        <div class="text">
                                            ...
                                            <div class="au-message__item">
                                                <div class="au-message__item-inner">
                                                    <div class="au-message__item-text">
                                                        <div class="avatar-wrap">
                                                            <div class="avatar">
                                                                <img src="{{ asset('theme/images/icon/avatar-05.jpg')}}" alt="Michelle Sims">
                                                            </div>
                                                        </div>
                                                        <div class="text">
                                                            <h5 class="name">Michelle Sims</h5>
...
<!-- Jquery JS-->
<script src="{{ asset('theme/js/vanilla-utils.js') }}"></script>
<!-- Bootstrap JS-->
<script src="{{ asset('theme/vendor/bootstrap-5.3.7.bundle.min.js') }}"></script>
<!-- Vendor JS       -->
...
<!-- Main JS-->
<script src="{{ asset('theme/js/bootstrap5-init.js') }}"></script>
<script src="{{ asset('theme/js/main-vanilla.js') }}"></script>
<script src="{{ asset('theme/js/swiper-bundle.min.js') }}"></script>
<script src="{{ asset('theme/js/aos.js') }}"></script>
<script src="{{ asset('theme/js/modern-plugins.js') }}"></script>
